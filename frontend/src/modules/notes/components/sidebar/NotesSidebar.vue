...
const emit = defineEmits(['toggle-collapse', 'select-note', 'create-note', 'show-templates'])
        ...
        <div v-if="favoriteNotes.length > 0" class="mb-4">
          ...
          <div v-show="expandedSections.favorites" class="mt-1 space-y-0.5">
            <button
              ...
              class="w-full flex items-center gap-2 rounded px-2 py-1.5 text-sm text-gray-300 hover:bg-dark-700"
            >
