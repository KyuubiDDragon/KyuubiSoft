  ...
  <div>
    ...
    <div v-if="data?.productivity_score" class="mb-4">
      <div class="flex items-center justify-between mb-2">
        <span class="text-gray-400 text-sm">{{ $t('dashboardModule.productivityScore') }}</span>
    ...
    <div v-if="data?.tasks_completed?.daily?.length" class="mt-4">
      <p class="text-sm text-gray-400 mb-2">{{ $t('dashboardModule.completedTasks14Days') }}</p>
