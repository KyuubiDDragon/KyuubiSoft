      ...
      <div class="card">
        ...
        <div v-else>
          <div
            ...
            :key="expense.id"
            class="flex items-center gap-4 px-6 py-3 hover:bg-white/[0.04] transition-colors border-b border-white/[0.06]/50 last:border-0"
          >
            <span
          ...
          <div class="modal w-full max-w-md">
            ...
            <div class="p-6 space-y-4">
              <div class="space-y-2 max-h-48 overflow-y-auto">
                <div v-for="cat in financeStore.categories" :key="cat.id" class="flex items-center gap-3 p-2 rounded-lg bg-white/[0.04]">
      ...
      <Transition enter-active-class="transition ease-out duration-200" enter-from-class="opacity-0" enter-to-class="opacity-100"
        ...
        <div v-if="showIncomeCategoryForm" class="fixed inset-0 bg-black/60 backdrop-blur-md z-50 flex items-center justify-center p-4" @click.self="showIncomeCategoryForm = false">
          <div class="modal w-full max-w-md">
            ...
            <div class="p-6 space-y-4">
              <div class="space-y-2 max-h-48 overflow-y-auto">
                <div v-for="cat in financeStore.incomeCategories" :key="cat.id" class="flex items-center gap-3 p-2 rounded-lg bg-white/[0.04]">
                  <span class="w-3 h-3 rounded-full" :style="{ backgroundColor: cat.color }"></span>
                  <span class="flex-1 text-sm text-white">{{ cat.name }}</span>
