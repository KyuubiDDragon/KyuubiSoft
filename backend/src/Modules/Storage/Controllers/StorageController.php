...
class StorageController
{
    ...
    public function update(ServerRequestInterface $request, ResponseInterface $response, array $args): ResponseInterface
    {
        ...
        $this->db->update('storage_files', $updates, ['id' => $fileId]);

        $updatedFile = $this->db->fetchAssociative('SELECT * FROM storage_files WHERE id = ?', [$fileId]);
    ...
    public function delete(ServerRequestInterface $request, ResponseInterface $response, array $args): ResponseInterface
    {
        ...
        $this->db->delete('storage_files', ['id' => $fileId]);
     ...
     */
    public function updateShare(ServerRequestInterface $request, ResponseInterface $response, array $args): ResponseInterface
    {
        $userId = $request->getAttribute('user_id');
        $fileId = $args['id'];
        $data = $request->getParsedBody() ?? [];
     ...
     * Delete a share
     */
    public function deleteShare(ServerRequestInterface $request, ResponseInterface $response, array $args): ResponseInterface
    {
        $userId = $request->getAttribute('user_id');
        $fileId = $args['id'];
        ...
        $this->db->delete('storage_shares', ['file_id' => $fileId]);
     ...
     */
    public function getPublicShare(ServerRequestInterface $request, ResponseInterface $response, array $args): ResponseInterface
    {
        $token = $args['token'];
     ...
     */
    public function downloadPublic(ServerRequestInterface $request, ResponseInterface $response, array $args): ResponseInterface
    {
        $token = $args['token'];
        $data = $request->getParsedBody() ?? [];
        $queryParams = $request->getQueryParams();
